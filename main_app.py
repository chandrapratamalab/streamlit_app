...
if app_mode == 'Home':
    ...
    Loan_Amount_Term = st.sidebar.selectbox('Loan_Amount_Term', (12.0, 36.0, 60.0, 84.0, 120.0,
    ...
    # Konversi biner untuk Dependents
    ...
    if st.button("Click to Predict"):
        ...
        if prediction[0] == 0:
            ...
            st.markdown(
                f'<img src="data:image/gif;base64,{data_url_no}" alt="rejected gif">',
                unsafe_allow_html=True
            )
        else:
            st.success('Congratulations! You will get the loan from the bank.')
            st.markdown(
                f'<img src="data:image/gif;base64,{data_url}" alt="approved gif">',
                unsafe_allow_html=True
            )
